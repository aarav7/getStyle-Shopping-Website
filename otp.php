            ...
            <div class="row g-0">
              ...
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <h4 class="login-form-title text-left mb-4">OTP Verification</h4>
                  ...
                  <form action="otp_processing.php" method="POST">
                    ...
                    <div class="text-right">
                      <button class="btn btn-dark btn-block mb-4 d-block ml-auto" style="margin-left:auto" name="submit" type="submit">Submit</button>
                    </div>
